...
void MT9V034_Init(unsigned char fps)
{
	...
	if(SCCB_RegRead(MT9V034_I2C_ADDR>>1,MT9V034_CHIP_VERSION,&data) == 0)  //读取摄像头版本寄存器
	{
		...
		{
			OLED_P6x8Str(5, 5, "LQ-V034 id error");
			while (1);
		}
	}
	else
	{
		OLED_P6x8Str(5, 5, "LQ-V034 sccb error");
...
//	MT9V034_Default_Settings();
    ...
    /* 0xA5  图像亮度  60  1-64  */
    SCCB_RegWrite(MT9V034_I2C_ADDR,MT9V034_AGC_AEC_DESIRED_BIN_REG, 45);
...
void MT9V034_SetAutoExposure(char enable)
{
    ...
    if(enable)
    {
        ...
        SCCB_RegWrite(MT9V034_I2C_ADDR, MT9V034_MAX_EXPOSURE_REG, 270);//CAMERA_MAX_EXPOSURE_TIME);
        ...
        SCCB_RegWrite(MT9V034_I2C_ADDR, MT9V034_MAX_GAIN_REG, 35);
